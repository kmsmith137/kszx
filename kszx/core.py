...
def fft_r2c(box, arr, spin=0, threads=None):
    ...
    for i in range(2*spin+1):
        ...
        cpp_kernels.multiply_xli_fourier_space(ret, tmp2, spin, i, box.npix[2], sign * eta_i * prefactor * box.pixel_volume, (i > 0))
...
def fft_c2r(box, arr, spin=0, threads=None):
    ...
    for i in range(2*spin+1):
        ...
        cpp_kernels.multiply_xli_real_space(ret, tmp2, spin, i, box.lpos[0], box.lpos[1], box.lpos[2], box.pixsize, eta_i * prefactor, (i > 0))
